...
export async function createBuyOrder({ sessionid, mhn, priceTotal, quantity = 1, billing }, post = directPost) {
  // Champs de facturation requis (sans eux Steam retourne success:22).
  ...
  // Code postal : selon les versions Steam attend billing_po ou billing_postal_code
  const pc = b.billing_po || b.billing_postal_code;
  if (pc) { fields.billing_po = pc; fields.billing_postal_code = pc; }
